    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            >
                                AI-Powered Stock Anomaly Detection
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center md:text-right">
                        ...
                        >
                            Built by{' '}
                            <span style={{ color: 'var(--foreground)' }}>Umang Kumar Chaudhary</span>
                        </p>
                        <p
                ...
                {/* Tech Stack Tags */}
                <div
                    className="mt-6 pt-6 border-t flex flex-wrap justify-center gap-2"
                    style={{ borderColor: 'var(--border)' }}
                >
                    {[
                        'Next.js', 'TypeScript', 'Python', 'FastAPI', 'PostgreSQL',
                        'Scikit-learn', 'Pandas', 'yfinance', 'Tailwind CSS'
                    ].map((tech) => (
                        <span
                            key={tech}
